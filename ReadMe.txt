...
5) If you are using visual studio 2019 , then simply click solution files in each folder to open project. 
6) If using VS Code , then navigate to solution file containg folder on command prompt / terminal of VS code and type below commands.
	a) dotnet build
	b) dotnet run
